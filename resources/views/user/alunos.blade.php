...
<html lang="pt-br">
    ...
    <meta charset="utf-8">
        ...
        <!-- Title / Icon -->
        <title>Gestão-CFC - Alunos-CFC</title>
                ...
                <div class="carta">
                    <div class="card">
                        <div class="card-content">
                            <span class="card-title activator grey-text text-darken-4">Alunos</span>
                            <button id="btn-cadastrar" class="btn waves-effect waves-light blue-grey darken-3" type="submit" name="action">
                                <a href="{{ route('aluno.create') }}" class="white-text">Cadastrar</a>
                        ...
                        <div class="row" id="filtro">
                            <form action="{{ route('aluno.search') }}" method="POST" class="col s6">
                                @csrf
                            ...
                            <thead>
                                ...
                                @forelse($alunos as $aluno)
                                    <tr>
                                        ...
                                        <th>{{ $aluno->carteira_categoria }}</th>
                                        <th>{{ $aluno->cfc_pertencente }}</th>
                                        <th>{{ $aluno->cfc->nome }}</th>
                                        <th>
                                            <button class="btn waves-effect waves-light blue-grey darken-3">
                                                <a class="white-text" href="{{ route('aluno.edit', $aluno->id) }}">
