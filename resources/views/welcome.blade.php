    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-white dark:bg-gray-900 sm:items-center py-4 sm:pt-0">            
            <div class="fixed top-0 right-0 px-6 py-4 sm:block">                    
                <a href="{{ route('admin.view') }}" class="text-sm text-gray-700 underline">Login ADM</a>                    
                <a href="{{ route('user.view') }}" class="text-sm text-gray-700 underline">Login CFC</a>
            </div>  
            <div class="grey lighten-2 titulo container">
