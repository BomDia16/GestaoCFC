...
<html lang="pt-br">
    ...
    <meta charset="utf-8">
        ...
        <!-- Title / Icon -->
        <title>Gestão-CFC - CFCs-Create-ADM</title>
                ...
                <div class="carta">
                    <div class="card">
                        <div class="card-content">
                            <span class="card-title activator grey-text text-darken-4">Cadastro de novo CFC</span>
                        </div>
                        <hr>
                        <div class="card-image waves-effect waves-block waves-light">
                            <form action="{{ route('cfc.store') }}" method="post">
                                @csrf
                                <!-- Nome -->
                                ...
                                <!-- cnpj -->
                                <div class="input-field col s6">
                                    <input name="cnpj" id="cnpj" type="text" class="validate @error('cnpj') is-invalid @enderror">
                                ...
                                <div class="input-field col s12">
                                    <input name="razao-social" id="razao-social" type="text" class="validate @error('razao-social') is-invalid @enderror">
