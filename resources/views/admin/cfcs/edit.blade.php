...
<html lang="pt-br">
    ...
    <meta charset="utf-8">
        ...
        <!-- Title / Icon -->
        <title>Gestão-CFC - CFCs-Edit-ADM</title>
                ...
                <div class="carta">
                    <div class="card">
                        <div class="card-content">
                            <span class="card-title activator grey-text text-darken-4">Editar CFC</span>
                        </div>
                        <hr>
                        <div class="card-image waves-effect waves-block waves-light">
                            <form action="{{ route('cfc.update', $cfcs->id) }}" method="post">
                                @csrf
                                @method('put')

                                <!-- Nome -->
                                <div class="input-field col s6">
                                    <input name="nome" type="text" id="nome" class="validate @error('nome') is-invalid @enderror" value="{{ $cfcs->nome }}">
                                ...
                                <!-- Email -->
                                <div class="input-field col s6">
                                    <input name="email" id="email" type="text" class="validate @error('email') is-invalid @enderror" value="{{ $cfcs->email }}">
                                ...
                                <!-- cnpj -->
                                <div class="input-field col s6">
                                    <input name="cnpj" id="cnpj" type="text" class="validate @error('cnpj') is-invalid @enderror" value="{{ $cfcs->cnpj }}">
                                ...
                                <!-- celular -->
                                <div class="input-field col s6">
                                    <input name="celular" id="celular" type="text" class="validate @error('celular') is-invalid @enderror" value="{{ $cfcs->celular }}">
                                ...
                                <div class="input-field col s12">
                                    <input name="razão_social" id="razao-social" type="text" class="validate @error('razao-social') is-invalid @enderror" value="{{ $cfcs->razão_social }}">
