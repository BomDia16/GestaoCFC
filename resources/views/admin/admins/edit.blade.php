...
<html lang="pt-br">
    ...
    <meta charset="utf-8">
        ...
        <!-- Title / Icon -->
        <title>Gestão-CFC - Admins-Edit-ADM</title>
                ...
                <div class="carta">
                    <div class="card">
                        <div class="card-content">
                            <span class="card-title activator grey-text text-darken-4">Editar Admin</span>
                        </div>
                        <hr>
                        <div class="card-image waves-effect waves-block waves-light">
                            <form action="{{ route('admin.update', $admins->id) }}" method="post">
                                ...
                                <div class="input-field col s6">
                                    <input name="nome" type="text" id="nome" class="validate @error('nome') is-invalid @enderror" value="{{ $admins->nome }}">
                                ...
                                <!-- Email -->
                                <div class="input-field col s6">
                                    <input name="email" id="email" type="text" class="validate @error('email') is-invalid @enderror" value="{{ $admins->email }}">
                                ...
                                <!-- cpf -->
                                <div class="input-field col s6">
                                    <input name="cpf" id="cpf" type="text" class="validate @error('cpf') is-invalid @enderror" value="{{ $admins->cpf }}">
                                ...
                                <!-- celular -->
                                <div class="input-field col s6">
                                    <input name="celular" id="celular" type="text" class="validate @error('celular') is-invalid @enderror" value="{{ $admins->celular }}">
                                ...
                                <div class="input-field col s12">
                                    <input name="senha" id="senha" type="text" class="validate @error('senha') is-invalid @enderror">
