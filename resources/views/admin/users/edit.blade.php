...
<html lang="pt-br">
    ...
    <meta charset="utf-8">
        ...
        <!-- Title / Icon -->
        <title>Gestão-CFC - Users-Edit-ADM</title>
                ...
                <div class="carta">
                    <div class="card">
                        <div class="card-content">
                            <span class="card-title activator grey-text text-darken-4">Editar Usuário</span>
                        </div>
                        <hr>
                        <div class="card-image waves-effect waves-block waves-light">
                            <form action="{{ route('user.update', $users->id) }}" method="post">
                                ...
                                <div class="input-field col s6">
                                    <input name="nome" type="text" id="nome" class="validate @error('nome') is-invalid @enderror" value="{{ $users->nome }}">
                                ...
                                <!-- Email -->
                                <div class="input-field col s6">
                                    <input name="email" id="email" type="text" class="validate @error('email') is-invalid @enderror" value="{{ $users->email }}">
                                ...
                                <!-- cpf -->
                                <div class="input-field col s6">
                                    <input name="cpf" id="cpf" type="text" class="validate @error('cpf') is-invalid @enderror" value="{{ $users->cpf }}">
                                ...
                                <!-- celular -->
                                <div class="input-field col s6">
                                    <input name="celular" id="celular" type="text" class="validate @error('celular') is-invalid @enderror" value="{{ $users->celular }}">
                                ...
                                <div class="input-field col s12">
                                    <select class="black-text" name="cfc_id" id="cfc_id" type="text" class="validate @error('cfc_id') is-invalid @enderror">
                                        @forelse($cfcs as $cfc)
                                            <option class="black-text" name="cfc_id" value="{{ $cfc->id }}" <?= $users->cfc_id == $cfc->id ? 'selected' : '' ?>>{{ $cfc->nome }}</option>
                                        @empty
                                        @endforelse
                                    </select>
